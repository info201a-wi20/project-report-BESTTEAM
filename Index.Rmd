...
By our observation, there is not much outliers in our data because many of them are manually imported and they are from reliable resourse. Some data like the data of COVIS-19 of some European countries may be an outlier for some cases, but for our cases, we only use them for summation so they are not outliers in our case.
...
#### 2. 
This question is interesting because we are able to find out if people’s willingness to participate in the economy is an issue and if there is anything we need to do about it, considering the severity of the coronavirus. 
