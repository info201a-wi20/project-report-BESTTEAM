...
natural_gas <- read.csv("~/Desktop/daily_csv.csv", stringsAsFactors = FALSE)
ng <- natural_gas[5794:5813,]

confirmed1 <- read_dta("~/Desktop/confirmed.dta")
...
x <- rbind(confirmed, c("Mean", "7.303","8.592","12.38","18.87","27.87","38.51","73.39",
                   ...
                   "794.3", "880.1","908.3","937.2","964.0","988.7","995.3","1002.6"))
